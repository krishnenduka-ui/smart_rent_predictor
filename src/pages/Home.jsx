  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-[url('/src/assets/images/bg-image.jpg')] bg-cover bg-center text-white font-bold text-center p-30 h-100">
        ...
        <Link to="/rentals">
          <button className="mt-6 bg-white text-green-600 px-6 py-3 rounded hover:text-gray-300">
            Explore rentals
          </button>
        </Link>
      ...
      <div className="bg-gray-100 py-16 px-6 text-center">
        ...
        <Link to="/rent-estimator">
          <button className="mt-4 bg-emerald-600 text-white px-6 py-3 rounded">
            Rent Estimator
          </button>
        </Link>
      </div>
      ...
      <section className="py-16 px-6">
        ...
        <h2 className="text-center sm:text-xl md:text-2xl lg:text-3xl font-bold">Homes You’ll Love</h2>
         <p className="mt-5 sm:text-sm md:text-base lg:text-lg  text-center">Our featured properties </p>
